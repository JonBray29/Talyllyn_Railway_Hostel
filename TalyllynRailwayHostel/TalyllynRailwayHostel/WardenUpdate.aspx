<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WardenUpdate.aspx.cs" Inherits="TalyllynRailwayHostel.WardenUpdate" %>
        ...
        <br />
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        ...
                        <asp:TextBox runat="server" ID="txtFirstName" ReadOnly="True" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"/>
                        <asp:TextBox runat="server" ID="txtLastName" ReadOnly="True" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"/>
                </div>

                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">Number of Female And Male Guests</span>
                    </div>
                        <asp:TextBox runat="server" ID="txtNumberOfFemale" ReadOnly="True" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"/>
                        <asp:TextBox runat="server" ID="txtNumberOfMale" ReadOnly="True" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"/>
                </div>
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        ...
                        <asp:TextBox runat="server" ID="txtArriveDate" TextMode="Date" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"/>
                    <div class="input-group-prepend">
                        <span class="input-group-text">Departure date:</span>
                    </div>
                        <asp:TextBox runat="server" ID="txtDepartDate" TextMode="Date" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"/>
                </div>

                
                <br />
                <p>To update your booking - Change the dates above then click 'Update This Booking'</p>

                <div class="row mt-5 text-center">
                    <div class="col">
                        <asp:Button runat="server" Text="Back" ID="btnBack" class="btn btn-outline-primary"></asp:Button>
                    </div>
                    <div class="col">
                        <asp:Button runat="server" Text="Assign Beds" ID="btnAssign" class="btn btn-outline-info"></asp:Button>
                    </div>
                    <div class="col">
                        <asp:Button runat="server" Text="Update Booking" ID="btnUpdate" class="btn btn-outline-success" OnClientClick = "return confirm('Are you sure you want to update this booking?')"></asp:Button>
                    </div>
                    <div class="col">
                        <asp:Button runat="server" Text="Cancel Booking" ID="btnDelete" class="btn btn-outline-danger" OnClientClick = "return confirm('Are you sure you want to delete this booking?')"></asp:Button>
                    </div>
                </div>                
