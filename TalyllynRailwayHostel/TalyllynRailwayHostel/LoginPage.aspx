<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="TalyllynRailwayHostel.LoginPage" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <div class ="formClass" style="position: static; margin-left: 41%;">
                <asp:TextBox ID="txtusernameInsert" runat="server" placeholder="Username" Width="30%"></asp:TextBox> <br />
                <asp:TextBox ID="txtpasswordInsert" runat="server" TextMode="Password" placeholder="Password" Width="30%"></asp:TextBox> <br />
                <asp:Button ID="btnLogin" class="btn btn-outline-success" runat="server" onclick="btnLogin_Click" Text="Login" Width="30%"></asp:Button>
            </div>
        </div>
