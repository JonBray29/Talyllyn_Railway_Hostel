<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfirmBooking.aspx.cs" Inherits="TalyllynRailwayHostel.ConfirmBooking" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <div style="position: static; margin-left: 10px;">
            <asp:Button ID="btnBack" class="btn btn-outline-primary" runat="server" Text="Back" OnClick="btnBack_Click" />
        </div>
        <br />
        <br />

        <div>
            <h1><asp:Label ID="lblConfirmBooking" runat="server" Text="Label"></asp:Label></h1>
        </div>
        
           <h1>Please Note: You will be notified when your booking has been confirmed.</h1><br />
        <br />
        <br />
