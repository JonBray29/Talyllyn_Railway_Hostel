<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VolunteerSelectBooking.aspx.cs" Inherits="TalyllynRailwayHostel.WebForm1" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
                ...
                <div class="row mt-5 text-center">
                    <div class="col">
                        <asp:Button runat="server" Text="Back" ID="btnBack" OnClick="btnBack_Click" class="btn btn-outline-primary"></asp:Button>
                    </div>
                    <div class="col">
                        <asp:Button runat="server" Text="Update This Booking" ID="btnUpdate" class="btn btn-outline-success" OnClick="btnUpdate_Click" OnClientClick = "return confirm('Are you sure you want to update this booking?')"></asp:Button>
                    </div>
                    <div class="col">
                        <asp:Button runat="server" Text="Cancel This Booking" ID="btnDelete" class="btn btn-outline-danger" OnClick="btnDelete_Click" OnClientClick = "return confirm('Are you sure you want to cancel this booking?')"></asp:Button>
                    </div>
                </div>                
