<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PastBooking.aspx.cs" Inherits="TalyllynRailwayHostel.PastBooking" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <div class="row text-center">
            <div class ="col">
            <asp:GridView ID="GridBookings" Width="100%" runat="server">
                        <Columns>
