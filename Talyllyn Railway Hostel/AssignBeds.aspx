<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignBeds.aspx.cs" Inherits="TalyllynRailwayHostel.AssignBeds" %>
...
<%--                <asp:Panel ID="Panel1" runat="server">
                ...
                <div class="row mt-5 text-center">
                    ...
                    <div class="col">
                        <asp:Button runat="server" Text="Confirm booking" ID="btnConfirm" class="btn btn-outline-success" OnClientClick = "return confirm('Are you sure you want to confirm this booking?')"></asp:Button>
                    </div>
                </div>                
